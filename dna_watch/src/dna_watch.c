...
PBL_APP_INFO(MY_UUID,
             "Chromosomes", "Lightwriter Visions",
             1, 0, /* App version */
...
void handle_init(AppContextRef ctx) {
  ...
  window_init(&window, "Chromosomes Watch");
  ...
  hour_image_container.layer.compositing_mode = GCompOpAssignInverted;
  ...
  minute_image_container.layer.compositing_mode = GCompOpAssignInverted;
